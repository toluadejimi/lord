...
Route::get('change-password',  [HomeController::class,'change_password']);
    ...
    Route::post('vas/purchase', [VtuController::class, 'purchase'])->name('vas.purchase');
    Route::post('vas/validate-bill', [VtuController::class, 'validateBill'])->name('vas.validate-bill');
