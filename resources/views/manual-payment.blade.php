            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ url('admin/manual-payment') }}"><i class="fas fa-money-check-alt"></i> Manual Payment</a>
                        </li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($data->receipt ?? null)
                                                        <a href="{{ url('') }}/public/upload/receipt/{{ $data->receipt }}" target="_blank" rel="noopener">View receipt</a>
                                                    @else
                                                        —
                                                    @endif
                                                </td>
