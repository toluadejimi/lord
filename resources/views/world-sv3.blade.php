...
<div class="pc-container"><div class="pc-content p-4">
    ...
    <h2>World Server 3 — SMS Bower</h2>
    <form method="post" action="{{ url('order-world-sv3') }}" class="card card-body mb-4">@csrf
    ...
    @include('partials.verification-list', ['verifications' => $verifications, 'pollUrl' => 'get-smscode-sv3'])
</div></div>
@endsection
