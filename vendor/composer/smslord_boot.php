...
/**
 * SMSLORD helper loader — lives in vendor/ so it deploys with composer autoload.
 */
if (!function_exists('smslord_load_helpers')) {
    function smslord_load_helpers(?string $base = null): void
    {
        $base = $base ?? (defined('SMSLORD_BASE') ? SMSLORD_BASE : dirname(__DIR__, 2));
        ...
        if (!function_exists('deployed_from_project_root')) {
            ...
            {
                $base = defined('SMSLORD_BASE') ? SMSLORD_BASE : dirname(__DIR__, 2);
